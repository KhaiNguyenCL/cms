 ...
 */
router.post('/', authorize('ADMIN', 'MANAGER', 'CONTENT_MANAGER'), validate(createPlaylistSchema), playlistsController.createPlaylist);
 ...
 * @access  ADMIN, MANAGER
 */
router.put('/:id', authorize('ADMIN', 'MANAGER', 'CONTENT_MANAGER'), validate(updatePlaylistSchema), playlistsController.updatePlaylist);
 ...
 * @access  ADMIN only
 */
router.delete('/:id', authorize('ADMIN', 'CONTENT_MANAGER'), playlistsController.deletePlaylist);
 ...
 * @access  ADMIN, MANAGER
 */
router.post('/:id/items', authorize('ADMIN', 'MANAGER', 'CONTENT_MANAGER'), validate(addItemSchema), playlistsController.addItem);
 ...
 */
router.put('/:id/items/reorder', authorize('ADMIN', 'MANAGER', 'CONTENT_MANAGER'), validate(reorderItemsSchema), playlistsController.reorderItems);
 ...
 * @access  ADMIN, MANAGER
 */
router.put('/:id/items/:itemId', authorize('ADMIN', 'MANAGER', 'CONTENT_MANAGER'), validate(updateItemSchema), playlistsController.updateItem);
 ...
 * @access  ADMIN, MANAGER
 */
router.delete('/:id/items/:itemId', authorize('ADMIN', 'MANAGER', 'CONTENT_MANAGER'), playlistsController.removeItem);
